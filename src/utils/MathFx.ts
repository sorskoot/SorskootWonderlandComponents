...
function sinerp(start: number, end: number, value: number): number {
 ...
 */
function directionalAngleDelta(first: number, second: number, forward: boolean): number {
...
function moveTowardsAngleDirection(
    current: number,
    target: number,
    maxDelta: number,
    forward: boolean
