import {Mesh, MeshAttribute, MeshIndexType, MeshManager} from '@wonderlandengine/api';

export class MeshUtils {
    // no need to create an instance of this class
    private constructor() {}

    static createPlane(meshBuilder: MeshManager, width = 1, height = width): Mesh {
        const vertexCount = 4;
